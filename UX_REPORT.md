...
The single highest-leverage thing PrepNext can do this quarter is **stop being three products in one URL**. Pick the placement-OS story, name it everywhere, and design the first 90 seconds of the experience to deliver on that promise. Everything else in this report is a consequence of that one decision.
