...
export function roadmapPrompt({ topic, level = "Beginner", style = "step_by_step" }) {
  return `You are PrepNxt, an expert curriculum architect. Build a comprehensive learning ROADMAP on "${topic}" tailored for a ${level} learner who prefers ${style} explanations.
