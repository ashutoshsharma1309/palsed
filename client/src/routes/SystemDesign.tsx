          ...
          <div className="grid sm:grid-cols-3 lg:grid-cols-5 gap-3">
            {TOOLS.map((t) => (
              <a
                ...
                className="border border-white/10 hover:border-[var(--color-neon)] rounded-lg p-4 group"
              >
                <div className="flex items-center justify-between mb-2">
                  <div className="font-bold">{t.name}</div>
                  <ExternalLink className="w-3 h-3 text-white/30 group-hover:text-[var(--color-neon)]" />
                </div>
